...
void utf8_to_utf16(unsigned char* const utf8_str, int utf8_str_size, wchar_t* utf16_str_output, int utf16_str_output_size);

#endif

#ifdef __STD_UTF_16__IMPLEMENTATION
...
void utf8_to_utf16(unsigned char* const utf8_str, int utf8_str_size, wchar_t* utf16_str_output, int utf16_str_output_size) {
	...
	wchar_t* utf16_currentCodeUnit = utf16_str_output;
	...
	while (*utf8_currentCodeUnit && (utf16_str_iterator < utf16_str_output_size || utf8_str_iterator < utf8_str_size)) {
		...
		if (*utf8_currentCodeUnit < 0x80) {
			...
			*utf16_currentCodeUnit = (wchar_t) (*utf8_currentCodeUnit);
			...
			wchar_t highShort = (wchar_t) ((*utf8_currentCodeUnit) & 0x1F);

			//Increment the current code unit pointer to the next code unit
			utf8_currentCodeUnit++;

			//Work on the second code unit.
			wchar_t lowShort = (wchar_t) ((*utf8_currentCodeUnit) & 0x3F);
			...
			if ((0 <= unicode && unicode <= 0xD7FF) || (0xE000 <= unicode && unicode <= 0xFFFF)) {
				...
				*utf16_currentCodeUnit = (wchar_t) unicode;
				utf16_currentCodeUnit++;
				utf16_str_iterator++;
			}
			...
			wchar_t fourthChar = (wchar_t) ((*utf8_currentCodeUnit) & 0xF);
			utf8_currentCodeUnit++;
			wchar_t thirdChar = (wchar_t) ((*utf8_currentCodeUnit) & 0x3C) >> 2;
			wchar_t secondCharHigh = (wchar_t) ((*utf8_currentCodeUnit) & 0x3);
			utf8_currentCodeUnit++;
			wchar_t secondCharLow = (wchar_t) ((*utf8_currentCodeUnit) & 0x30) >> 4;
			wchar_t firstChar = (wchar_t) ((*utf8_currentCodeUnit) & 0xF);
			utf8_currentCodeUnit++;
			...
			wchar_t sixthChar = (wchar_t) ((*utf8_currentCodeUnit) & 0x4) >> 2;
			wchar_t fifthCharHigh = (wchar_t) ((*utf8_currentCodeUnit) & 0x3);
			utf8_currentCodeUnit++;
			wchar_t fifthCharLow = (wchar_t) ((*utf8_currentCodeUnit) & 0x30) >> 4;
			wchar_t fourthChar = (wchar_t) ((*utf8_currentCodeUnit) & 0xF);
			utf8_currentCodeUnit++;
			wchar_t thirdChar = (wchar_t) ((*utf8_currentCodeUnit) & 0x3C) >> 2;
			wchar_t secondCharHigh = (wchar_t) ((*utf8_currentCodeUnit) & 0x3);
